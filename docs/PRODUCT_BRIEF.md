...
- Mixer graph in [MIXER.md](MIXER.md): per-voice fader, pan, mute, solo, two FVS insert slots, aux 1 to Mover, aux 2 to a two-engine Spatializer, two master insert slots.
...
3. Replace insert stubs and the aux Mover / Spatializer stubs with real Fashion Victim processing. Topology and parameter ids stay.
